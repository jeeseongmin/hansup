		...
		<div class="w-full h-full">
			...
			<div>
				<HomeContent
					image={Catering}
					title="수화식당"
					text="수화식당은 국내 최초 청각장애인 레스토랑으로, 한식과 양식을 판매하는 식당입니다."
					color="homePink"
					reverse="true"
				/>
				<HomeContent
					image={Catering}
					title="케이터링"
					text="행사, 기념일에 고객님께서 더 풍성하고 행복하게 보내도록 맛난 케이터링 서비스를 제공합니다! "
					color="homeGray"
					reverse="false"
				/>
				<HomeContent
					image={Lunchbox}
					title="도시락"
					text="한숲 도시락은 대상 맞춤형 음식들을 풍성하게 담아 합리적인 가격으로 제공합니다."
					color="homePink"
					reverse="true"
				/>
			</div>
			<div class="px-28 py-20">
				...
				<div class="flex">
					<div class="border border-black w-3/10 h-80">image</div>
					<div class="border border-black w-3/10 mx-16">image</div>
					<div class="border border-black w-3/10">image</div>
				</div>
			</div>
		</div>
	);
