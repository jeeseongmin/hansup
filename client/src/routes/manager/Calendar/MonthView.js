    ...
    <div class='flex flex-col w-full justify-center items-center'>
      <div class='w-full flex justify-center items-center relative'>
        <div class='flex flex-row items-center mb-4'>
          <button onClick={() => changeMonth(false)} class='cursor-pointer'>
            <IoIosArrowBack style={style} size={28} />
          </button>
          <button class='text-hansupBrown text-2xl font-bold mx-8'>
            {focusDate.year()}년 {focusDate.month() + 1}월
          </button>
          <button onClick={() => changeMonth(true)} class='cursor-pointer'>
