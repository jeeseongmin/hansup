  ...
  useEffect(() => {
    const focusEvent = (e) => {
      ...
      if (
        ...
        !textArr.includes(e.target.innerText)
      ) {
        setFocusedMenu(0);
      }
    };
          ...
          */}
          <MenuContainer>
            ...
            >
              ...
              />
              {/* sideMenu */}
              <ul class={focusedMenu === 1 ? "block" : "hidden"}>
                <li>
                  <Submenu
                    title={"인사말"}
                    url={"/intro/introduction"}
            ...
            >
              ...
              />
              {/* sideMenu */}
              <ul class={focusedMenu === 2 ? "block" : "hidden"}>
                <li>
                  <Submenu
                    title={"수화식당"}
                    url={"/business/restaurant"}
            ...
            >
              <Menu
                ...
                currentMenu={currentMenu}
              />
              <ul class={focusedMenu === 4 ? "block" : "hidden"}>
                <li>
                  <Submenu
                    title={"공지사항"}
                    url={"/community/notice/list"}
            ...
            >
              <Menu
                ...
                currentMenu={currentMenu}
              />
              <ul class={focusedMenu === 5 ? "block" : "hidden"}>
                {/* sideMenu */}
                <li>
                  <Submenu
                    title={"한숲맛이야기"}
